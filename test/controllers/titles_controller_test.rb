...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference("Title.count") do
      post titles_url, params: { title: { author_id: @title.author_id, barcode: @title.barcode, genre_id: @title.genre_id, name: @title.name } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { author_id: @title.author_id, barcode: @title.barcode, genre_id: @title.genre_id, name: @title.name } }
